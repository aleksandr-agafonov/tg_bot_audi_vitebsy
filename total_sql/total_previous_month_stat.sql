...
unique_calls_yandex as (
	...
	where general_dates.simple_date BETWEEN dateadd(month, DATEDIFF(month, 0, dateadd(Month, -1, eomonth(GETDATE()))), 0) and dateadd(Month, -1, eomonth(GETDATE()))
...
adcosts as (
	...
	or general_dates.simple_date BETWEEN dateadd(month, DATEDIFF(month, 0, dateadd(Month, -1, eomonth(GETDATE()))), 0) and dateadd(Month, -1, eomonth(GETDATE()))
